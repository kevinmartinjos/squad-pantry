# Generated by Django 2.0 on 2018-02-06 07:03
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.IntegerField(choices=[(0, 'Order Placed'), (2, 'Rejected'), (1, 'Accepted'), (3, 'Cancelled'), (4, 'Processing'), (5, 'Delivered')], default=0)),
